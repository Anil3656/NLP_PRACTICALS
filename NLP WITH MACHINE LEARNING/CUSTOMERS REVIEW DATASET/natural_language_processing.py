...
dataset = pd.read_csv(r"D:\Data Science Daily Updates\Senapthi_calss_Notes\NLP CLASS\NLP PROJECTS\1.CUSTOMERS REVIEW DATASET\Restaurant_Reviews.tsv", delimiter = '\t', quoting = 3)
